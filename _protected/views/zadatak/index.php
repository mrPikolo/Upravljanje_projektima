...
/* @var $searchModel app\models\ZadatakSearch */
...
?>
<div class="zadatak-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a('Create Zadatak', ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Projekat', 'id' => 'grid-zadatak-search-projekat_id']
            ],
        'covjek_casova',
